...
\university{UI : stack.py}{Universitas Indonesia}{ui}
\team{stack.py}{Thanks to our handsome members:\\R. Fausta \textbf{"faustaadp"} Anugrah Dianparama\\Pikatan \textbf{"Pyqe"} Arya Bramajati\\Hocky \textbf{"hocky"} Yudhiono}
